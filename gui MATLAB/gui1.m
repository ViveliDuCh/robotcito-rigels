...
% Last Modified by GUIDE v2.5 28-Mar-2023 16:21:53
...
set(handles.text4,'string','SUP -Vivi');
pause(1.0);
set(handles.text4,'string','HOLI UWU -Polo');
...
if valor_connect == 1
    ...
    %connect_ar = arduino('COM4'); %Checar el puerto al que se conecta el arduino
